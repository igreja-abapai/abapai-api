...
export class CreateMember1741542058699 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."member_gender_enum" AS ENUM('Masculino', 'Feminino')`);
        await queryRunner.query(`CREATE TYPE "public"."member_maritalstatus_enum" AS ENUM('Solteiro', 'Casado', 'Divorciado', 'Viúvo')`);
        await queryRunner.query(`CREATE TYPE "public"."member_educationlevel_enum" AS ENUM('Ensino Fundamental', 'Ensino Médio', 'Curso Técnico', 'Ensino Superior', 'Pós-Graduação', 'Mestrado', 'Doutorado', 'Outro')`);
        ...
        await queryRunner.query(`ALTER TABLE "prayer_request" ALTER COLUMN "name" SET DEFAULT 'Anônimo'`);
