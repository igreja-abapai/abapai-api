...
export class AddMemberAddressRelationship1741543718445 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "member" ADD CONSTRAINT "UQ_813c7d0f53916afbd1624c4e304" UNIQUE ("addressId")`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "member" DROP CONSTRAINT "UQ_813c7d0f53916afbd1624c4e304"`);
